 ...
 */
#ifndef SOR_PACKETQUEUE_H
#define SOR_PACKETQUEUE_H
...
/**
 * When a route is not available, the packets are queued. Every node can buffer packets and the implementaion is for a "drop front on full" queue 
 * where the first queued packet will be dropped
